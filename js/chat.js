...
class ChatSystem {
    constructor() {
        ...
        // Core properties
        this.api = window.api; // API.js နဲ့ချိတ်ဆက်
        this.messages = [];
    ...
    async setup() {
        ...
        // Test API connection using api.js
    ...
    async callAPI(message) {
        ...
        try {
            // API.js ရဲ့ chat function ကိုခေါ်မယ်
