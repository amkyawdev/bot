// js/chat.js - Complete Chat System with Worker API Integration
...
class ChatSystem {
    ...
    getOfflineResponse(message) {
        ...
        // Greetings
        if (lower.match(/^(hello|hi|hey|greetings)/i)) {
        ...
        if (lower.includes('code') || lower.includes('programming') || lower.includes('function')) {
            return "💻 I'd be happy to help with coding! Please specify the language and what you need.";
        }
    ...
    analyzeIntent(message) {
        ...
        if (lower.includes('think') || lower.includes('ponder')) {
            this.setStatus('thinking');
        } else if (lower.includes('create') || lower.includes('make') || lower.includes('generate')) {
            this.setStatus('creating');
        } else if (lower.includes('build') || lower.includes('develop')) {
            this.setStatus('building');
        } else if (lower.includes('read') || lower.includes('analyze')) {
            this.setStatus('reading');
        } else if (lower.includes('solve') || lower.includes('calculate')) {
            this.setStatus('solving');
        } else if (lower.includes('bad') || lower.includes('inappropriate')) {
            this.setStatus('prohibited');
        } else {
            this.setStatus('thinking');
        }
    }
    ...
    addMessage(role, content, file = null) {
        ...
        // Voice button (for assistant and user messages)
        let actionsHtml = '';
